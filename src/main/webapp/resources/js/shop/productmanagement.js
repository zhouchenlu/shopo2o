$(function () {
    // 获取此店铺下的商品列表的URL
    var listUrl = '/ShopO2O/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    var statusUrl = '/ShopO2O/shopadmin/modifyproduct';
    getList();
        ...
        .on(
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/ShopO2O/shopadmin/productoperation?productId='
                    ...
                    window.location.href = '/ShopO2O/frontend/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
