$(function () {
    ...
    var pageSize = 3;
    // 列出商品列表的URL
    var listUrl = '/ShopO2O/frontend/listproductsbyshop';
    // 默认的页码
    var pageNum = 1;
    // 从地址栏里获取ShopId
    ...
    var searchDivUrl = '/ShopO2O/frontend/listshopdetailpageinfo?shopId=' + shopId;
    ...
    // $('#exchangelist').attr('href', '/ShopO2O/frontend/awardlist?shopId=' +
    // shopId);
    // 获取本店铺信息以及商品类别信息列表
